...
if platform.system().lower() == 'windows':
    ...
    from util.get_stock_rose import getRose, harden
elif platform.system().lower() == 'linux':
    from get_stock_info import getStockDateLineAll, getStockNameInfo
    from get_stock_rose import getRose, harden
...
scheduler.add_job(harden, 'cron', day_of_week='*', hour=20, minute='20', second='00')
scheduler.start()
